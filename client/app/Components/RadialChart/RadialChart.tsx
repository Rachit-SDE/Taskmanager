...
function RadialCHart() {
  ...
  return (
    <Card className="flex flex-col h-[100%] shadow-none bg-card">
      <CardHeader className="items-center pb-0">
        <CardTitle>Comleted vs Pending Tasks</CardTitle>
        <CardDescription>Task completion status.</CardDescription>
      </CardHeader>
      <CardContent className="flex  h-[200px] items-center">
        <ChartContainer
          config={chartConfig}
          className="h-[190px] mt-[30px] aspect-square w-full max-w-[250px]"
        >
          <RadialBarChart
            data={chartData}
            endAngle={180}
      ...
      <CardFooter className="flex-col gap-2 text-sm mt-[-50px]">
